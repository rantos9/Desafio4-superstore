...
def prophet(timeseries):
    ...
    # Escolhendo a quande de cycles para a prediçao (Frequencia semanal)
    future_dates = my_model.make_future_dataframe(periods=cycles, freq='7D')

    # Executando a predição do modelo (predicao é feita externamente)
